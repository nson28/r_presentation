---
title: "Week 3 assignment with plotly"
...
- This project was created as part of the assignment for Developing Data Products course at Coursera. 
-  The goal of this project was to create a slide presentation deployed over the web through a web page.
- This project features the use of Plotly in creating plots.

- The plot on the  next page shows the  number of raod accidents in Great Britain from 2005 to 2015, grouped by severity (slight, serious, or fatal).
...
accidents15 <- accidents15 %>% select(Accident_Severity, Date)
